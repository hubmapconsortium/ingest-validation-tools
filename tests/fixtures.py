...
SAMPLE_BLOCK_PARTIAL_RESPONSE_BAD = b'{"schema":{"name":"Sample Block"},"reporting":[{"errorType":"notStandardTerm","column":"processing_time_unit","row":0,"repairSuggestion":"minute","value":"min"},{"errorType":"notStandardTerm","column":"source_storage_duration_unit","row":0,"repairSuggestion":"minute","value":"min"}]}'

SAMPLE_BLOCK_PARTIAL_RESPONSE_GOOD = b'{"schema":{"name":"Sample Block"},"reporting":[]}'
