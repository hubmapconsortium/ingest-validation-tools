...
#             (
#                 True,
#                 {"http://entities_testHBM233.CGGG.482": SAMPLE_BLOCK_PARTIAL_ENTITY_API_RESPONSE},
...
#         self,
#         good: bool,
#         entity_api_response_map: dict[str, str],
#         path: str,
#         schema_name: str,
...
#                 side_effect=lambda url, globus_token, headers: entity_api_side_effect(
#                     entity_api_response_map, url, globus_token, headers
#                 ),
#             ):
...
#
#
# def entity_api_side_effect(response_map, url, *args, **kwargs):
#     del args, kwargs
#     breakpoint()
