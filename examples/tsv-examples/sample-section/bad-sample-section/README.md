...
- 'On row 2, column "preparation_condition", value "bad" fails because it is not one
  of these: "frozen in liquid nitrogen", "frozen in liquid nitrogen vapor", "frozen
  in ice", "frozen in dry ice", "frozen at -20 C", "ambient temperature", "unknown".'
...
- 'On row 2, column "storage_media", value "bad" fails because it is not one of these:
  ...
  (CMC)", "None".'
- 'On row 2, column "storage_method", value "bad" fails because it is not one of these:
  "frozen in liquid nitrogen", "frozen in liquid nitrogen vapor", "frozen in ice",
  "frozen in dry ice", "frozen at -80 C", "frozen at -20 C", "refrigerator", "ambient
  temperature", "incubated at 37 C", "none", "unknown".'
