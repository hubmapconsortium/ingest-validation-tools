...
- On row 2, column "section_thickness_value", value "" fails because constraint "required"
  is "True"
- On row 2, column "section_thickness_unit", value "um / mm / cm" fails because constraint
  "enum" is "['um', 'mm', 'cm']"
- On row 2, column "section_index_number", value "" fails because constraint "required"
  is "True"
- On row 2, column "area_unit", value "mm^2 / um^2" fails because constraint "enum"
  is "['mm^2', 'um^2']"
