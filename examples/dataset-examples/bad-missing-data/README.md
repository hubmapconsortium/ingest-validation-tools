...
Antibodies/Contributors Errors:
  ...
  - On row(s) 2, 3, column "contributors_path", value "contributors-missing.tsv" points
    to non-existent file "examples/dataset-examples/bad-missing-data/upload/contributors-missing.tsv".
