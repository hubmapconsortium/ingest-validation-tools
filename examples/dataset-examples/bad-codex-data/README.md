...
Upload Errors:
  TSV Errors:
    examples/dataset-examples/bad-codex-data/upload/contributors.tsv (as codex):
    ...
    examples/dataset-examples/bad-codex-data/upload/antibodies.tsv (as codex):
  ...
  Directory Errors:
    examples/dataset-examples/bad-codex-data/upload/dataset-1 (as codex):
