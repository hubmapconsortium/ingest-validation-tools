...
Upload Errors:
  TSV Errors:
    ...
    - 'On row 2, column "orcid_id", value "bad-id" fails because URL returned 404:
      "https://pub.orcid.org/v3.0/bad-id". Example: 0000-0002-8928-741X.'
    - 'On row 3, column "orcid_id", value "0000-0000-0000-0000" fails because URL
      returned 404: "https://pub.orcid.org/v3.0/0000-0000-0000-0000". Example: 0000-0002-8928-741X.'
    - 'On row 4, column "orcid_id", value "0000-0000-0000-0000" fails because URL
      returned 404: "https://pub.orcid.org/v3.0/0000-0000-0000-0000". Example: 0000-0002-8928-741X.'
