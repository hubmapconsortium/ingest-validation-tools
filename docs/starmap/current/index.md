...
This is the most recent metadata specification that needs to be followed for the submission of new data. See the [harmonized specification](https://docs.hubmapconsortium.org/assays/metadata/starmap.html) for a view of the metadata across this and any previous versions.
...
| <code>raw\/starmap\/.*</code> |  | All relevant raw files for STARmap. |
| <code>lab_processed\/.*</code> | ✓ | Experiment files that were processed by the lab generating the data. |
| <code>lab_processed\/starmap\/.*</code> |  | All relevant experiment files for STARmap. |
