...
This is the most recent metadata specification that needs to be followed for the submission of new data. See the [harmonized specification](https://docs.hubmapconsortium.org/metadata/assay/confocal.html) for a view of the metadata across this and any previous versions.
