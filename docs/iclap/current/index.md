...
This is the most recent metadata specification that needs to be followed for the submission of new data. See the [harmonized specification](https://docs.hubmapconsortium.org/assays/metadata/iclap.html) for a view of the metadata across this and any previous versions.
...
| <code>raw\/iclap\/.*</code> |  | All relevant raw files for iCLAP. |
| <code>lab_processed\/.*</code> | ✓ | Experiment files that were processed by the lab generating the data. |
| <code>lab_processed\/iclap\/.*</code> |  | All relevant experiment files for iCLAP. |
