...
- [💻 Source code](https://github.com/hubmapconsortium/ingest-validation-tools/edit/master/src/ingest_validation_tools/table-schemas/codex.yaml): Make a PR if this doc should be updated.
...
| constraint | value |
| --- | --- |
| enum | `BZ-X800` or `BZ-X710` or `Axio Observer Z1` |
| required | `True` |
