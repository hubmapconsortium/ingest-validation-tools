...
The three other fields function the same way for all assays using antibodies:
...
from [The Antibody Registry](https://antibodyregistry.org/)
and [UniProt](https://www.uniprot.org/) respectively.
