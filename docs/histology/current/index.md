...
This is the most recent metadata specification that needs to be followed for the submission of new data. See the [harmonized specification](https://docs.hubmapconsortium.org/assays/metadata/histology.html) for a view of the metadata across this and any previous versions.
...
| <code>raw\/images\/[^\/]+\.ets$</code> |  | Raw pixel-data stacks containing the full-resolution image data pertaining to the overview/label image contained in the corresponding Olympus VSI file. |
