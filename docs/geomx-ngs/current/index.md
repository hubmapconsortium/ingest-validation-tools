...
This is the most recent metadata specification that needs to be followed for the submission of new data. See the [harmonized specification](https://docs.hubmapconsortium.org/assays/metadata/geomx-ngs.html) for a view of the metadata across this and any previous versions.
...
<summary><b>Version 2.11 (use this one)</b></summary>
...
| <code>raw\/[^\/]+\.pkc$</code> | ✓ | The file listing probe barcode sequence and corresponding gene symbol and, if appropriate, proteins targeted by that probe. This should be consistent for the same probe panel. |
...
<summary><b>Version 2.10</b></summary>
