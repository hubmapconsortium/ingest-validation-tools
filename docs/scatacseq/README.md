...
- [📝 TSV template](https://raw.githubusercontent.com/hubmapconsortium/ingest-validation-tools/master/docs/scatacseq/scatacseq-metadata.tsv): Use this to submit metadata.
...
| constraint | value |
| --- | --- |
| enum | `snRNA-seq (SNARE-seq) [Lab Processed]`, `scATAC-seq (SNARE-seq) [SnapATAC]`, `scRNA-seq (SNARE-seq) [Lab Processed]`, `scATAC-seq (SNARE-seq) [Lab Processed]`, `sciATAC-seq`, or `sciATAC-seq [SnapATAC]` |
| required | `True` |
