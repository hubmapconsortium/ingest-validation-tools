...
| `HuBMAP_OME/region_[^/]+/S[^/]+\.ome\.tif` | `HuBMAP_OME/region_011/S20030092_region_011.ome.tif` | ✓ | OME TIFF Files for the corresponding region (e.g. region_001) by slide (e.g S20030077) |
| `HuBMAP_rounds/round_info_S[^/]*\.dat` | `HuBMAP_rounds/round_info_S20030078_002.dat` | ✓ | Metadata file for the capture by slide (e.g S20030077) item-value tab separated format |
